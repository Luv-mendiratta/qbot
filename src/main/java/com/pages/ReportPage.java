...
public class ReportPage extends BasePage implements ReportPageConstant{
	/*Importing the TestUtils */
	TestUtils util = new TestUtils();

	/*Defining the Elements with there respective path*/

	@FindBy (xpath="/html/body/div[1]/div[2]/section/div[1]/div[1]/div/div/h1")
	public WebElement TitleText;
	
	@FindBy (xpath="/html/body/div[1]/div[2]/section/div[1]/div[2]/div/table/tbody/tr[1]/td[1]")
	public WebElement Urltested;
	...
	public ReportPage() throws IOException, InterruptedException  
	{
